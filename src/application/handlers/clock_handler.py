...
class ClockHandler:
    ...
    async def send_events(cls, delay:int = 10, batch_size:int = 10, session: AsyncSession = None):
        while True:
            ...
            await rabbitmq.publish(routing_key=RoutingKeys.FILE_PROCESSOR, message={"metadata_ids": file_ids})
